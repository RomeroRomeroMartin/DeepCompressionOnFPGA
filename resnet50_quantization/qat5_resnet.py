...
model.qconfig = quantization.qconfig.QConfig(activation=act, weight=weights)
...
torch.jit.save(traced_model, 'ResnetModels/modelo_qat5bits_resnet50_cifar10_jit.pth')

...
class MobileNetV2(py_nndct.nn.NndctQuantModel):
    def __init__(self):
        ...
        self.module_100 = py_nndct.nn.Linear(in_features=1280, out_features=128, bias=True) #MobileNetV2::MobileNetV2/Sequential[classifier]/Linear[1]/ret.233(MobileNetV2::nndct_dense_100)

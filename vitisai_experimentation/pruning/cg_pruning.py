...
torch.save(slim_model.sparse_state_dict(), 'models/cg_pruned_os02_sparse.pth')
torch.save(slim_model.state_dict(), 'models/cg_pruned_os02_mask.pth')


print("Modelo fine-tuned guardado en 'models/cg_pruned_os095.pth'.")
